...
const sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por elrebelde, tu seras SharksBot-MD`;
...
handler.command = /^(openaivoz|chatgptvoz|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|Lolivoz|SharksBotvoz|gptvoz|ai_voz|ai_voce)$/i;
