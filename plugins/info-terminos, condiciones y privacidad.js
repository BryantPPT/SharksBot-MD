...
let Terminos = `*_Toda la información que se mencione aquí no excluye a la Propietario del Bot, y Propietarios Acredores al uso de SharksBot-MD_*
...
_- El chat anónimo del comando #start, valga la redundancia no mostrará ningún dato de los Usuarios por parte de The SharksBot. Eso no implica que las personas que hagan uso de esta función puedan dar a conocer sus datos. en Número(s) Oficial(es)._
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarán las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento de SharksBot-MD._
...
> *~ Muchas Gracias Por tomarte el tiempo en informate sobre SharksBot-MD*`.trim()
