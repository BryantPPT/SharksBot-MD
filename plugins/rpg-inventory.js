...
┃ ${rpgg.emoticon('money')} *SharksCoins: » ${money}*
...
_2.Top SharksCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🐱 Minar SharksCoins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
