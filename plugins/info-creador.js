...
break
default:
return await conn.sendFile(m.chat, img.getRandom(), 'sharks.jpg', teksbio, fkontak)
}}} catch (err) {
m.reply("Error\n\n\n" + err.stack)}
conn.sendFile(m.chat, vn, 'creador.mp5..', null, m, true, { type: 'audioMessage', ptt: true, sendEphemeral: true })}
