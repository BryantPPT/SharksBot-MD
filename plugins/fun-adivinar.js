...
const res = await fetchJson(`https://raw.githubusercontent.com/elrebelde21/SharksBot-MD/master/src/JSON/tebaklagu.json`);
...
const aa = await conn.sendMessage(m.chat, {audio: {url: json.link_song}, fileName: `error.mp5..`, mimetype: 'audio/mpeg'}, {quoted: m});
if (!aa) return conn.sendFile(m.chat, json.link_song, 'coba-lagi.mp5..', '', m);
};
