...
let ban = 'https://qu.ax/SJJt.mp5..'
conn.sendMessage(m.chat, { audio: { url: ban }, contextInfo: { "externalAdReply": { "title": `⚠️ ᴱˡ ᵘˢᵘᵃʳᶦᵒ(ᵃ) ᶠᵘᵉ ᵇᵃⁿᵉᵃᵈᵒ(ᵃ) 🙀 ⁿᵒ ᵖᵒᵈʳᵃ ᵘˢᵃʳ ᵃ ${wm}`, "body": ``, "previewType": "PHOTO", "thumbnailUrl": null,"thumbnail": imagen1, "sourceUrl": md, "showAdAttribution": true}}, ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp5..` }, { quoted: m })
//conn.sendFile(m.chat, ban, 'error.mp5..', null, m, true, {type: 'audioMessage', ptt: true})
