...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por elrebelde21, tu seras SharksBot-MD`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por elrebelde21, tu seras SharksBot-MD`
...
handler.command = /^(openai|chatgpt|ia|openai2|chatgpt2|ia2|Sharks)$/i;
