...
if (!text) return await conn.reply(m.chat,  `${lenguajeGB['smsAvisoMG']()}𝘿𝙚𝙗𝙚𝙨 𝙚𝙨𝙘𝙧𝙞𝙗𝙞𝙧 𝙚𝙡 𝙣𝙤𝙢𝙗𝙧𝙚\n𝙀𝙟:\n*${usedPrefix + command} Sharks*`, m, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: mg, body: ' 💫 𝐒𝐮𝐩𝐞𝐫 𝐁𝐨𝐭 𝐃𝐞 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 🥳 ', previewType: 0, thumbnail: img.getRandom(), sourceUrl: redes.getRandom()}}})    
try {
