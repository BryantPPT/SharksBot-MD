...
let vn = 'https://qu.ax/xynz.mp5..'
this.sendPresenceUpdate('recording', m.chat)   
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp5..', mimetype: 'audio/mp4', ptt: true }, { quoted: m })}  

if (/^ara ara$/i.test(m.text) && chat.audios) {  
let vn = 'https://qu.ax/PPgt.mp5..'
this.sendPresenceUpdate('recording', m.chat)   
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp5..', mimetype: 'audio/mp4', ptt: true }, { quoted: m })} 

if (chat.audios && m.text.match(/(bienveni|🥳|🤗)/gi)) {
//let vn = './media/Bienvenido.mp5..'
let vn = 'https://qu.ax/cUYg.mp5..'
this.sendPresenceUpdate('recording', m.chat)   
conn.sendMessage(m.chat, { audio: { url: vn }, contextInfo: { "externalAdReply": { "title": wm, "body": `🦈`, "previewType": "PHOTO", "thumbnailUrl": null,"thumbnail": imagen1, "sourceUrl": md, "showAdAttribution": true}}, ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp5..` }, { quoted: m })}
    
if (chat.audios && m.text.match(/(Blackpink in your area|blackpink in your area|in your area|In your area)/gi)) {    
let vn = 'https://qu.ax/pavq.mp5..'
this.sendPresenceUpdate('recording', m.chat)   
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp5..', mimetype: 'audio/mp4', ptt: true }, { quoted: m })}
    
if (chat.audios && m.text.match(/(Buen día grupo|Buen dia grupo)/gi)) {    
let vn = 'https://qu.ax/GoKq.mp5..'
this.sendPresenceUpdate('recording', m.chat)   
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp5..', mimetype: 'audio/mp4', ptt: true }, { quoted: m })}
    
if (chat.audios && m.text.match(/(Calla Fan de bts|bts|Amo a bts)/gi)) {
let vn = 'https://qu.ax/oqNf.mp5..'
let sticker = 'https://qu.ax/rfHP.webp'
this.sendPresenceUpdate('recording', m.chat)
let or = ['audio', 'sticker'];
let media = or[Math.floor(Math.random() * 2)]
if (media === 'audio') await this.sendFile(m.chat, vn, 'error.mp5..', null, m, true, {type: 'audioMessage', ptt: true });
...
let vn = './media/la-voz-de-hombre.mp5..'
this.sendPresenceUpdate('recording', m.chat)   
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp5..', mimetype: 'audio/mp4', ptt: true }, { quoted: m })}
