...
return await conn.reply(m.chat,  `😿 𝙇𝘼𝙈𝙀𝙉𝙏𝘼𝘽𝙇𝙀𝙈𝙀𝙉𝙏𝙀 *${yo}* 𝙎𝙀 𝙃𝘼 𝙉𝙀𝙂𝘼𝘿𝙊 🚫 𝙀𝙉 𝙀𝙎𝙏𝘼𝙍 𝙀𝙉 𝙐𝙉𝘼 𝙍𝙀𝙇𝘼𝘾𝙄𝙊𝙉 𝘾𝙊𝙉𝙏𝙄𝙂𝙊 *${tu}*\n𝙉𝙊 𝙀𝙎𝙏𝙀𝙎 𝙏𝙍𝙄𝙎𝙏𝙀, 𝘼𝙐𝙉 𝙏𝙄𝙀𝙉𝙀𝙎 𝙈𝙐𝘾𝙃𝘼𝙎 𝘾𝙊𝙎𝘼𝙎 𝙋𝙊𝙍 𝙃𝘼𝘾𝙀𝙍 🍃`, `*${tu} 💔 ${yo}*\n`, m, {contextInfo: {mentionedJid: [user, tu, yo], externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '', previewType: 0, thumbnail: gataImg.getRandom(), sourceUrl: accountsgb.getRandom()}}})
