...
const smsModP2 = () => { return `Ativar função para que todos possam usar o SharksBot`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o SharksBot em Grupos`}
...
const smsContacto4 = () => { return 'Contato Oficial SharksBot 🦈'}
