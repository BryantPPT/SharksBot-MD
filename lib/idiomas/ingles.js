...
const smsModP2 = () => { return `Enable function so everyone can use SharksBot`}
const smsModAd1 = () => { return `🛂 ADMIN MODE`}
const smsModAd2 = () => { return `Only Admins will be able to use SharksBot in Groups`}
...
const smsContacto4 = () => { return 'SharksBot Official Contact 🦈'}
