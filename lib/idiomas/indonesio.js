...
//_allantilink.js
const smsTextoYT = () => { return '😻 Super SharksBot-MD - WhatsApp '}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan SharksBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan SharksBot di Grup`}
...
const smsContacto4 = () => { return 'Kontak Resmi SharksBot 🦈'}
