...
const smsVersion = () => { return `𝙑𝙚𝙧𝙨𝙞𝙤𝙣 𝙙𝙚𝙡 🦈`}
...
const eSharksCoins = () => { return '🪙 SharksCoins' }
const eSharksTickers = () => { return '🎫 sharks Tickers' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar a SharksBot`}
...
const smsContacto4 = () => { return 'Contacto Oficial de SharksBot 🦈'}
