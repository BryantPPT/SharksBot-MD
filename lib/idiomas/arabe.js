...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز SharksBot-MD - WhatsApp '}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام SharksBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام SharksBot في المجموعات`}
...
const smsContacto4 = () => { return 'جهة اتصال SharksBot الرسمية 🦈'}
