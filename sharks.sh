...
mp3_array=("https://qu.ax/vkZR.mp5.." "https://qu.ax/FYQy.mp5.." "https://qu.ax/rSUn.mp5.." "https://qu.ax/CCzM.mp5.." "https://qu.ax/nuFz.mp5.." "https://qu.ax/YKe.mp5..")
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/BryantPPT/SharksBot-MD\ncd SharksBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} SharksBot-MD${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando SharksBot!\n\033[0m"
npm start
